...
\hypersetup{
  pdftitle={Signed order count, queue imbalance, OFI, and depth-aware replay: TSLA, 2019},
  pdfauthor={Riad Darwish},
  pdfsubject={Conditional impact, next-price prediction, and finite-depth replay},
  pdfkeywords={market impact, queue imbalance, order flow imbalance, market microstructure, LOBSTER, C++, TSLA}
}
...
\vspace{0.5em}
\textbf{Keywords:} market impact, queue imbalance, order-flow imbalance,
market microstructure, chronological validation, order-book replay,
finite-size scaling
...
\citep{bouchaud2018,patzelt2018}. I ask two distinct questions for TSLA in 2019.
...
finite-depth transitions, and exports daily queue and joint queue/OFI bins. The
...
splits, complete-date resampling, queue/OFI ablation, grid robustness, and the
scaling regressions. Reproducing the annual transaction tables, replay, and
aggregate grids requires licensed LOBSTER files, which are not tracked.
